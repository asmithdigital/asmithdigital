 ...
 * https://modernizr.com/download/?-audio-contains-input-picture-srcset-supports-svg-template-addtest-fnbind-printshiv-setclasses-testprop !*/
!function (e, t, n) {
  function r(e, t) {
    ...
    function i() {
    ...
    }for (var u, d, f, h, g, v = ["modernizr", "tspan", "samp"]; !w.style && v.length;) {
      u = !0, w.modElem = l(v.shift()), w.style = w.modElem.style;
    }for (f = e.length, d = 0; f > d; d++) {
      if (h = e[d], g = w.style[h], s(h, "-") && (h = m(h)), w.style[h] !== n) {
        if (a || r(o, "undefined")) return i(), "pfx" == t ? h : !0;try {
          w.style[h] = o;
        } catch (y) {}if (w.style[h] != g) return i(), "pfx" == t ? h : !0;
      }
    }return i(), !1;
  }var g = [],
      v = { _version: "3.6.0", _config: { classPrefix: "", enableClasses: !0, enableJSClass: !0, usePrefixes: !0 }, _q: [], on: function on(e, t) {
      ...
      Modernizr = function Modernizr() {};Modernizr.prototype = v, Modernizr = new Modernizr();var y,
      S = [],
      E = t.documentElement,
      T = "svg" === E.nodeName.toLowerCase();!function () {
    var e = {}.hasOwnProperty;y = r(e, "undefined") || r(e.call, "undefined") ? function (e, t) {
    ...
    function n(e, t) {
      ...
      var t = w[e[T]];return t || (t = {}, C++, e[T] = C, w[C] = t), t;
    }function i(e, n, r) {
      if (n || (n = t), g) return n.createElement(e);r || (r = a(n));var o;return o = r.cache[e] ? r.cache[e].cloneNode() : E.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), !o.canHaveChildren || S.test(e) || o.tagUrn ? o : r.frag.appendChild(o);
    }function s(e, n) {
      if (e || (e = t), g) return e.createDocumentFragment();n = n || a(e);for (var o = n.frag.cloneNode(), i = 0, s = r(), l = s.length; l > i; i++) {
        o.createElement(s[i]);
      }return o;
    }function l(e, t) {
      ...
      e || (e = t);var r = a(e);return !b.shivCSS || h || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), g || l(e, r), e;
    }function u(e) {
      ...
      function t() {
        ...
        t();for (var a, i, s, l = e.styleSheets, c = [], d = l.length, p = Array(d); d--;) {
          p[d] = l[d];
        }for (; s = p.pop();) {
    ...
    }();var b = { elements: y.elements || "abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template time video", version: v, shivCSS: y.shivCSS !== !1, supportsUnknownElements: g, shivMethods: y.shivMethods !== !1, type: "default", shivDocument: c, createElement: i, createDocumentFragment: s, addElements: o };e.html5 = b, c(t);var _ = /^$|\b(?:all|print)\b/,
        N = "html5shiv",
        x = !g && function () {
  ...
  }("undefined" != typeof e ? e : this, t);var C = { elem: l("modernizr") };Modernizr._q.push(function () {
    delete C.elem;
  });var w = { style: C.elem.style };Modernizr._q.unshift(function () {
    delete w.style;
  ...
  }), Modernizr.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect);var b = l("input"),
      _ = "autocomplete autofocus list placeholder max min multiple pattern required step".split(" "),
      N = {};Modernizr.input = function (t) {
    for (var n = 0, r = t.length; r > n; n++) {
      N[t[n]] = !!(t[n] in b);
    }return N.list && (N.list = !(!l("datalist") || !e.HTMLDataListElement)), N;
  }(_);var x = "CSS" in e && "supports" in e.CSS,
      P = "supportsCSS" in e;Modernizr.addTest("supports", x || P), Modernizr.addTest("template", "content" in l("template")), Modernizr.addTest("contains", r(String.prototype.contains, "function")), o(), a(S), delete v.addTest, delete v.addAsyncTest;for (var j = 0; j < Modernizr._q.length; j++) {
    Modernizr._q[j]();
